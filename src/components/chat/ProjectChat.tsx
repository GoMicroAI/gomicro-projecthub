...
export const ProjectChat = forwardRef<HTMLDivElement, ProjectChatProps>(
  function ProjectChat({ projectId }, ref) {
    const { user } = useAuth();
    const {
      messages,
      isLoading,
    ...
    return (
      <div ref={ref} className="flex flex-col h-full border rounded-lg bg-card overflow-hidden">
        {/* Load More Button */}
        {hasMore && (
        ...
        {/* Attachment Preview */}
        {attachmentFile && (
          <div className="shrink-0 px-4 py-2 border-t bg-muted/50">
...
const MessageBubble = forwardRef<HTMLDivElement, MessageBubbleProps>(
  function MessageBubble({ message, isOwn, getInitials, isImage }, ref) {
    return (
      <div ref={ref} className={cn("flex gap-3", isOwn && "flex-row-reverse")}>
